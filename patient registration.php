...
$mhistory=$_POST["medicalhistory"];
$insuarance=$_POST["insuarance"];

$sql="INSERT INTO `patientregister`(`fullname`, `age`, `email`, `phonenumber`, `password`, `medicalhistory`, `insuarance`) VALUES
('$name','$age','$email','$pnumber','$password','$mhistory','$insuarance')"; 
            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  ...
                  <h4 class="mt-1 mb-5 pb-1">HEALTH CARE CLINIC<BR>PATIENT REGISTRATION</h4>
                </div>
                ...
                <form action="" method="POST">
                  ...
                  <div data-mdb-input-init class="form-outline mb-4">
                    <input type="text" name="age" id="form2Example11" class="form-control"
                  ...
                  <div data-mdb-input-init class="form-outline mb-4">
                    <input type="text" name="phonenumber" id="form2Example11" class="form-control"
                  ...
                  <div data-mdb-input-init class="form-outline mb-4">
                    <input type="text" name="medicalhistory" id="form2Example11" class="form-control"
                      placeholder="Medical History" />
                    <label class="form-label" for="form2Example11" >Medical History</label>
                  </div>

                  
                  <div data-mdb-input-init class="form-outline mb-4">
                    <input type="text" name="insuarance" id="form2Example11" class="form-control"
                      placeholder="Insuarance" />
                    <label class="form-label" for="form2Example11" >Insuarance</label>
                  </div>
