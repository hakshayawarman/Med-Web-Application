...
$sql="INSERT INTO `nurseregister`(`fullname`, `pnumber`, `email`, `password`) VALUES
('$name','$pnumber','$email','$password')"; 
            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  ...
                  <h4 class="mt-1 mb-5 pb-1">HEALTH CARE CLINIC<BR>NURSE REGISTRATION</h4>
                </div>
